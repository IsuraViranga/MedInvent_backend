...
class EditOwnerAddressTwo {
    static async editAddressTwo(body,userId) {
      try {
        ...
        const result = await pool.query(querys.updateOwnerAddressTwo,[lineTwo,temp]);
...
module.exports=EditOwnerAddressTwo;